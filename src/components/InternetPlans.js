    ...
    const [sliderClasses, setSliderClasses] = useState([
        {
            ...
            reviews: 10594,
            reviewSummary: '10K',
            description: 'Select Shop now to see pricing and deals available at your address.',
            savingText: "Select Shop now to see pricing and deals available at your address.",
            features: [
        ...
        <>
            <div className="jsx-3741889289 grid-col-1 slick-arrow slick-prev slick-disabled fade-in">
                <button className="jsx-3142907309 btn-reset touch-space  " aria-label="Previous" onClick={onClick}>
                    <span className="jsx-3142907309 inline-flex flex-centered round  border color-white border-gray-400 color-gray-400 underlay-icon-bg  width-lg-all height-lg-all"><svg className="height-sm-all width-sm-all color-gray-400 " focusable="false" height="24" width="24" viewBox="0 0 32 32">
                ...
                <div className="row flex-wrap justify-center text-center ">
                    <div className="grid-col-12 grid-col-12-md grid-col-12-sm">
                        <div className="jsx-1725204834">
                            <h2 className="mar-b-xs heading-xxl">Choose how fast you want to go</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div className="jsx-1725204834  plan-toggle-cards-list-wrapper pad-t-xs">
                <div className="jsx-640618752 jsx-1371232659 carousel-v2 container pad-b-md">
                    <div className="jsx-640618752 jsx-1371232659 row-nowrap flex-items-center carousel-overflow">
                        <div className="carousel-navigation carousel-nav" aria-label="carousel buttons">
                            <span id="carousel_spanMsgLeft_messageFirst" className="hidden-spoken" tabindex="-1" aria-hidden="true" aria-label="You have reached the beginning. Disabling Previous button." role="text">
                            </span>
                            <button value="prev" aria-label="Scroll Left" aria-labelledby="carousel_spanMsgLeft_messageFirst" disabled="" className="carousel-control btn-reset touch-space">
                                <span className="inline-flex flex-centered round width-xl-all height-xl-all rotate180">
                                    <svg aria-label="scroll left" focusable="false" className="" height="32" width="32" viewBox="0 0 32 32"><path className="svg-base" d="M12.27 26.71l-1.41-1.42L20.15 16l-9.29-9.29 1.41-1.42L23 16z"></path></svg>
                                </span>
                            </button>
                        </div>
                    </div>
                    <div className="jsx-640618752 jsx-1371232659 grid-col-10 devicePadding carousel-track-container pad-t-xs">
                        <div className="jsx-640618752 jsx-1371232659 row-nowrap carousel-track">
                            ...
                            {sliderClasses.map((item, index) => (
                                <div key={index} className="jsx-640618752 jsx-1371232659 grid-col-4 carousel-item   allActive ">
                                            ...
                                            <div className="jsx-2176973199 pad-l-xs pad-r-xs pad-b-sm-all flex flex-column gap24 justify-between height-full">
                                                <div className="jsx-2176973199 flex flex-column gap24">
                                                    <div className="jsx-2176973199 plan-card-heading">
                                                        <h2 className="mar-b-none heading-md color-gray-800">{item.speed}</h2>
                                                    </div>
                                                    <div className="jsx-2176973199 plan-card-ratings">
                                                        <div className="jsx-284813413">
                                                            <Link href="/" className="jsx-284813413 star-rating inline-flex flex-items-stretch valign-bottom rel color-gray-800">
                                                                <div className="jsx-284813413 hidden-spoken">Rated 4.0526 out of 5 stars with 10594 reviews</div>
                                                                <div className="jsx-284813413 star-rating-stars flex">
                                                                    {[...Array(5)].map((_, starindex) => (
                                                                        <svg
                                                                            ...
                                                                            viewBox="0 0 16 16"
                                                                            className={`jsx-2439502770 ${getStarClass(starindex)}`}
                                                                        >
                                                                            <defs className="jsx-2439502770">
                                                                                <clipPath id={`star--${starindex}`} className="jsx-2439502770">
                                                                                    <path
                                                                            ...
                                                                            <rect
                                                                                ...
                                                                                y="0"
                                                                                fill={getStarClass(starindex) === 'filled' ? '#FFD700' : '#1d2329'} // Gold for filled, dark for unfilled
                                                                                width="100%"
                                                                                height="100%"
                                                    ...
                                                    <div className="jsx-2176973199 plan-toggle-accordion-wrapr plan-card-acc">
                                                        <div className="border-bottom border-gray-300">
                                                            <button className="accordion-cta btn-reset heading- line-h-normal letter-spacing-0 type-base width-full flex flex-items-top justify-between text-left pad-t-sm pad-b-sm link-icon type-sm font-bold hover color-cobalt-600">
                                                                <span className="reading-width">Features & benefits</span>
                                                            ...
                                                            <div className="jsx-3015755231 overflow-hidden animate-slide-open hide-focusable">
                                                                <div className="jsx-2176973199 flex-column gap24 pad-t-sm-all">
                                                                    {item.features.map((subitem, subindex) => (
                                                                        <div key={subindex} className="jsx-4151701284 flex flex-items-top gap8">
                                                                            <div className="jsx-4151701284 flex height-md-all width-md-all flex-shrink-0">
                                                                                <svg aria-hidden="true" focusable="false" className="" height="32" width="32" viewBox="0 0 32 32"><path className="svg-base" d="M11.33 26.75l-10-10 1.42-1.42 8.62 8.63 18-18 1.42 1.41z"></path></svg>
                                                                            </div>
                                                                            <div className="jsx-4151701284 flex flex-column flex-self-center">
                                                                                <div className="jsx-4151701284 inline-block">
                                                                                    <span className="type-sm font-bold mar-b-none rte-styles"><strong>{subitem}</strong></span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ))
