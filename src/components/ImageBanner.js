                    ...
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 lg:p-7 shadow-2xl border border-gray-100 aspect-square flex flex-col justify-center">
                        ...
                        <div className="mb-3">
                            <p className="text-gray-600 text-base leading-relaxed">
                                Enjoy blazing-fast internet and premium TV with zero down payment and no credit checks. 
                                Just pay on time for 6 months to unlock even more benefits.
                            </p>
                        ...
                        <div className="mb-5">
                            <p className="text-gray-500 text-xs leading-relaxed">
                                After 1000GB, speeds may reduce during peak times. IPTV features require active subscription. 
                                Single connection per home. Taxes & fees extra. Terms & conditions apply.
                            </p>
                        </div>
