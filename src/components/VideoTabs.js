        ...
        >
          <div className="bg-gradient-to-r from-red-600 to-red-600 rounded-2xl p-8 md:p-12 text-white shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-white text-red-600 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg">
                Get Started Today
              </button>
