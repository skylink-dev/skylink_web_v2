...
<span className="text-lg font-semibold text-slate-900">Skylink</span>
</a>
<nav className="hidden items-center gap-4 text-sm text-slate-600 md:flex">
<a href="/" className="hover:text-skylink-red">
Home
</a>
<a href="/plans" className="hover:text-skylink-red">
Plans
</a>
</nav>
</div>
...
No login required. Just enter your details, verify the amount, and pay securely.
</p>
</section>
...
<span className="font-semibold">{dueInfo.next_due_date}</span>.
</>
)}
</div>
)}
...
Payments are processed via a secure payment gateway. You will receive an SMS
