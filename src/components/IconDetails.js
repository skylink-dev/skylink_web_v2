        ...
        <section className="bg-gradient-to-b from-white to-gray-50 py-16 md:py-20 text-center relative overflow-hidden">
            ...
            >
                {iconslist.map((item, index) => {
                    // Skip the last item (index 5) when on the support page
                    if (page === 'support' && index === 5) return null;

                    // Determine href based on page and index
                    let href;
                    if (page === 'tv') {
                        ...
                        href = index === 0 ? "/contact-us" : // First icon on support page goes to contact-us
                            index === 1 ? "/tv" :
                                index === 2 ? "/accessories" :
                                    index === 3 ? "/plans" :
                                        index === 4 ? "/internet" :
