...
export default function ContactForm({
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setSelectedId((prev) => {
        const nextIndex =
          (contentData.findIndex((item) => item.id === prev) + 1) %
          contentData.length;
        ...
        <div className="container rel">
          ...
          <div className="row flex-wrap flex-items-stretch justify-center">
            <div className="grid-col-8">
              <div
                id="card-40"
                className="jsx-3510905018 jsx-2300775981 card flex-card radius-lg rel bgcolor theme-dark-bg-img flex-card-background"
                    ...
                    <div className="">
                      ...
                      >
                        ...
                        <button
                          ...
                          aria-label=" See details about this offer"
                        >
                          See offer details
                        </button>
                      </div>
                      <div className=" cta-container mar-t-xs font-color-change">
                        <Link
                          ...
                          id="button-:R456khjmH1:"
                          type="button"
                          aria-label="Shop iPhone 16 Pro"
                          href="/plans"
                        >
                          Shop now
                        </Link>
            ...
            <div className="grid-col-4">
              <div
                id="card-41"
                className="jsx-3886864564 jsx-2300775981 card flex-card radius-lg rel bgcolor theme-light-bg-img flex-card-background"
                  ...
                  <div className="jsx-3886864564 jsx-2300775981 flex-1 grid-col-6 pad-b-none max-width pad-md-lg pad-md-md pad-lg-sm">
                    <div className="jsx-3886864564 jsx-2300775981 ">
                      <div className="flex-1">
                        <form
                          className="contact-form-wrapper flex flex-column gap-md"
                        ...
                        >
                          ...
                          <div className="form-group">
                            <button
                              type="submit"
                              className="form-submit-btn btn-primary radius-md"
                            >
                              Send Message
                            </button>
                          </div>
