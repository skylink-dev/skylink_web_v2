...
const faqs = [
  {
    question:
      "What makes Skylink different from other broadband providers in Erode?",
    answer:
      "Skylink isn't just another internet provider - we're a local network built in Erode, for Erode. With over 10 years of experience, we combine high-speed fibernet connectivity with personal, city-based support - ensuring faster resolutions, better uptime, and a service that truly understands your needs.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. We offer customized broadband solutions with static IPs, SLA-backed uptime, and dedicated account support - designed for offices, retail outlets, and enterprises across Erode.",
  },
  {
    question: "How fast and reliable is Skylink's internet in Erode?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes, we provide free installation, router, and setup with all new connections in Erode - with no hidden charges or activation fees.",
  },
  {
    question: "How do I get a new Skylink connection?",
    answer:
      "Simply check connection availability in your area or request a free callback. Our Erode team will help you choose a plan and schedule installation - usually within 24 hours.",
  },
];
