...
export default function BilledCycle() {
    const { planOptions: { billedCycle }, activeNestedTab, setActiveNestedTab, checkCondition,  setActiveTag} = usePlans();
    return (
        checkCondition && (
            <>
                        ...
                        <div>
                            <div className="plans-tabs">
                                {billedCycle.map((option) => (
                                    ...
                                    >
                                        {option === "Yearly" ? "Annual" : option} {getBillingCycleLabel(option)}
                                    </div>
                                ))}
                            </div>
                        </div>
