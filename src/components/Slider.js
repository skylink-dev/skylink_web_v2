                ...
                <div className={`absolute-fill bgcolor bgcolor-fix ${color}`}></div>
                    <div className="container rel">
                        <div className="row flex-wrap flex-items-center justify-center">
                            ...
                            <h2 className="margin-b-none heading-inline heading-xxl">{title}</h2>
                            </div>
                        </div>
                    </div>
                    <section
                        ...
                        <div className="jsx-2137253706 film-strip-carousel-options-container container rel flex flex-items-center justify-center gap24 mar-t-md-lg mar-t-lg-md mar-t-lg-sm pad-b-xs">
                            <div className="jsx-2137253706 film-strip-carousel-options-wrapper flex-sm flex-items-center-sm rel">
                                <div className="jsx-2989659875 flex justify-center height-xs">
                                    <div role="tablist" aria-label="Slides" tabIndex="-1" className="jsx-2989659875 filmstrip-carousel-indicators flex gap8">
                                ...
                                <div data-testid="filmstrip_reel" className="jsx-2137253706 film-strip-reel flex height-auto flex-items-stretch" >
                                    {reorderedSlides.map((slide, index) => (
                                        ...
                                        <div
                                            ...
                                            aria-label={`${((activeIndex + index) % slides.length) + 1} of ${slides.length}`}
                                            className={`jsx-2137253706 film ${index === 0 ? 'active' : ''}`}
                                            style={{
                                            ...
                                            >
                                                <div className="jsx-1181136068 jsx-2300775981 row flex card-height-base rel flex-column">
                                                    <div className="jsx-1181136068 jsx-2300775981 flex-1 grid-col-6 pad-b-none pad-md-lg pad-md-md pad-lg-sm max-width">
                                                        ...
                                                        <h3 className="heading-md" dangerouslySetInnerHTML={{ __html: slide.heading }}></h3>
                                                        <div className="type-base mar-t-xs rte-styles">{slide.description}</div>
                                                        <div id={slide.legalButtonId} className="type-legal mar-t-xxs color-gray-700">
                                                            <span>{slide.legal}</span>
                                                            <button className="btn-reset nowrap" aria-label={slide.legalLabel}>
                                                                {slide.legalLabel}
                                                            </button>
                                                        </div>
