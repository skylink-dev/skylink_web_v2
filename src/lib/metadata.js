...
export function generateMetadata(options = {}) {
    ...
    const fullUrl = `${SITE_URL}${pageUrl.startsWith('/') ? pageUrl : `/${pageUrl}`}`;
...
export const pageMetadata = {
    ...
    internet: generateMetadata({
        ...
        additionalKeywords: ['unlimited internet', 'fiber optic internet', 'high-speed connection', 'no data caps', 'internet service provider'],
        pageUrl: '/internet'
    }),
    ...
    tv: generateMetadata({
        ...
        additionalKeywords: ['tv packages', 'tv channels', '4k tv', 'hd channels', 'cable tv alternative'],
        pageUrl: '/tv'
    }),
    ...
    ott: generateMetadata({
        ...
        description: "Stream your favorite content with our OTT services. Access popular streaming platforms at discounted rates.",
        additionalKeywords: ['ott platforms', 'streaming services', 'ott bundles', 'online streaming', 'video on demand'],
        pageUrl: '/ott'
    }),
    ...
    contact: generateMetadata({
        ...
        additionalKeywords: ['customer support', 'contact skylink', 'help center', 'technical support', 'service inquiry'],
        pageUrl: '/contact-us'
    }),
    ...
    about: generateMetadata({
        ...
        additionalKeywords: ['about skylink', 'company history', 'mission vision', 'internet provider india', 'fiber network'],
        pageUrl: '/about'
    }),
    ...
    plans: generateMetadata({
        ...
        description: "Compare our internet and TV plans to find the perfect package for your home or business.",
        additionalKeywords: ['internet plans', 'tv plans', 'combo packages', 'fiber plans', 'broadband packages', 'subscription plans'],
        pageUrl: '/plans'
    }),
    ...
    coimbatore: generateMetadata({
        ...
        additionalKeywords: ['coimbatore internet provider', 'fiber internet coimbatore', 'tv services coimbatore', 'best internet coimbatore', 'skylink coimbatore'],
        pageUrl: '/coimbatore'
    }),
    ...
    erode: generateMetadata({
        ...
        additionalKeywords: ['erode internet provider', 'fiber internet erode', 'tv services erode', 'best internet erode', 'skylink erode'],
        pageUrl: '/erode'
    }),
    ...
    tiruppur: generateMetadata({
        ...
        additionalKeywords: ['tiruppur internet provider', 'fiber internet tiruppur', 'tv services tiruppur', 'best internet tiruppur', 'skylink tiruppur'],
        pageUrl: '/tiruppur'
    }),
