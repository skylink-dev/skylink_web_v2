...
export const metadata = {
  ...
  description:
    "Explore Skylink's blog for the latest articles on internet technology, streaming services, smart home solutions, and digital lifestyle tips.",
  keywords: [
    "skylink blog",
    "internet articles",
    "streaming guides",
  ...
  openGraph: {
    title: "Blogs & Articles | Skylink",
    description:
      "Explore our latest articles on internet technology and digital lifestyle.",
