                ...
                className={`pricing-plan-package-wrap custom-plan ${
                  isMobile
                    ...
                    : `tab-active default-tab${
                        activeTag === "Customize Plan" ? " colorful" : " gray"
                      }`
                }`}
              >
                <h2
                          ...
                          onClick={() => {
                            ...
                            setActivePrice(
                              plans?.planOptions?.actualPrizeByZone?.[
                                "Tamil Nadu"
                              ]?.["Fixed Plan"]?.[activeMbps]?.[basePrice]?.[
                                cycle
                              ].price
                            );
                          }}
                        ...
                        <div
                          ...
                          onClick={() => {
                            ...
                            const midKey = Object.keys(midPlan || {})
                              .map(Number)
                              .sort((a, b) => a - b)[
                              Math.floor(Object.keys(midPlan || {}).length / 2)
                            ];
                            ...
                            setActivePrice(
                              plans?.planOptions?.actualPrizeByZone?.[
                                "Tamil Nadu"
                              ]?.["Fixed Plan"][mbps]?.[String(newBasePrice)]?.[
                                activeCycle
                              ]?.price
                            );
                          }}
                      ...
                      <AnimatePresence>
                        <motion.div
                          className={`accordion-body ${
                            openAccordionIndex === idx ? "accordion-active" : ""
                          }`}
