                            ...
                            <div className="flex pricing-plan-innovative-tags-wrap" style={{ alignItems: "center", justifyContent: "center", margin: "8px" }}>
                                {['Customize Plan', ...tags].flatMap((tag, tdx, arr) => [
                                    <div
                                        ...
                                        style={{ alignItems: "center", justifyContent: "center", cursor: 'pointer', flex: '1', maxWidth: '45%' }}
                                    >
                            ...
                            <div className="desktop-tab-switcher">
                                <div className="flex pricing-plan-innovative-tags-wrap">
                                    {['Customize Plan', 'Fixed Plan'].map((tag) => (
                                        ...
                                        >
                                            <span>{tag === 'Fixed Plan' ? 'Fixed Plans' : 'Customize Your Plan'}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className='tab-section-wrap'>
                            <div className="accordion-container">
                                ...
                                <div className={`pricing-plan-package-wrap custom-plan ${isMobile ? (activeTag === 'Customize Plan' ? 'tab-active' : 'tab-nonactive') : `tab-active default-tab${activeTag === 'Customize Plan' ? ' colorful' : ' gray'}`}`}>
                                    <h2 onClick={() => setActiveTag("Customize Plan")} style={{ cursor: "pointer" }}>Your Plan</h2>
                                ...
                                <div className={`accordion-left-bg ${isMobile ? (activeTag === 'Fixed Plan' ? 'tab-active' : 'tab-nonactive') : `tab-active default-tab${activeTag === 'Fixed Plan' ? ' colorful' : ' gray'}`}`}>
                                    <h2 onClick={() => setActiveTag("Fixed Plan")} style={{ cursor: "pointer" }}>Our Plan</h2>
                                                                    ...
                                                                    return (
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <div className="pricing-separate-files">
                                                                                <div className="mobile-alignmentfor-planname">
                                                                                    <div className="speed-wrap">
                                                                                            ...
                                                                                            <div className="speed-container">
                                                                                                <span className="speed-container-wrap">
                                                                                                    ...
                                                                                                    <span className="speed-container-price">
                                                                                                        <div className="speed-container-unit">{planInfo.speed.split(" ")[0]}</div>
                                                                                                        <div className="speed-container-mbps">{planInfo.speed.split(" ")[1]}</div>
                                                                                                    </span>
                                                                                                </span>
                                                                                                <div className="data-limit">{planInfo.dataLimit} Data</div>
                                                                                            </div>
                                                                                        )}</div>
                                                                                        ...
                                                                                        >
                                                                                            {insideAccordionIndex === key ? <KeyboardArrowRightIcon /> : <KeyboardArrowRightIcon />}
                                                                                        </button>
                                                                                    </div>
                                                                                    ...
                                                                                    <div className="pricing-plan-package-details mobile-only">
                                                                                        <div className="iconslist" style={{ "display": "flex", "columnGap": "12px" }}>
                                                                            ...
                                                                            <div className="p-4 border-t order-change">
                                                                                ...
                                                                                <img className="red-line-wrap" src="https://www.skylink.net.in/wp-content/uploads/2025/07/red-line.png" alt="red line" />
                                                                                <hr style={{ marginTop: "20px", color: "#dddddd" }} />
                                                                                <div className="pricing-plan-package-details">
                                                                                    <span className="mobile-hide">
                                                                                        <span className="special_price_wrap">₹{planInfo.basePrice} <span className="after-price-special-font-styling">X {
                                                                                            planInfo.billingCycle === "Monthly"
                                                                                                ? "1 Month"
                                                                                                : planInfo.billingCycle === "Quarterly"
                                                                                                    ? "3 Months"
                                    ...
                                    <div className="leftside-content-wrap">
                                        <div className="firstset">
                                            <h2 className="title-class" style={{ margin: "0px 10px" }}>
                                        ...
                                        <div className='plan-details-features' style={{ boxSizing: "border-box" }}>
                                            <span className="plan-details-feature-list">
                                                ...
                                                <span className="feature-list-ans">{activeMbps.replace(/mbps/i, " Mbps")}</span>
                                            </span>
                                            <span className="plan-details-feature-list">
                                                <span className="feature-list-head">Internet Price Base on Billing Cycle</span> 
                                                <span className="feature-list-ans">₹{activePrice} / {activeCycle === "Annual" ? 12 : activeCycle === "Half-Yearly" ? 6 : activeCycle === "Quarterly" ? 3 : activeCycle === "Monthly" ? 1 : 0}</span>
                                            </span>
                                            <span className="plan-details-feature-list">
                                                <span className="feature-list-head">Internet Charges</span> 
                                                <span className="feature-list-ans">₹{basePrice}</span>
                                            </span>
                                            <span className="plan-details-feature-list">
                                                <span className="feature-list-head">Installation Charges</span> 
                                                <span className="feature-list-ans">+ ₹{activeInstallation === "Free" ? 0 : activeInstallation}</span>
                                            </span>
                                            <span className="plan-details-feature-list">
                                        ...
                                        <div className="destop-subscribe-style">
                                            ...
                                            <div className="subscribe-wrap">
                                                <button className="subscribe" onClick={() => {
                                                    setIsOpen(!isOpen)
                                                }} data-price={activePrice} data-active-tab={activeMbps} data-active-nested-tab={activeCycle}>
                                                    Subscribe Now
                                                </button>
                                            </div>
                                        </div>
