...
export const PlanProvider = ({ children }) => {
    const [planOptions, setPlanOptions] = useState({
        ...
        pricing: {
            "30 Mbps": generatePricing(399, "Unlimited", "350+ Channels", "21+ OTTs", "30 Mbps", 1500),
            "50 Mbps": generatePricing(499, "Unlimited", "350+ Channels", "22+ OTTs", "50 Mbps", 1000),
            "100 Mbps": generatePricing(699, "Unlimited", "350+ Channels", "22+ OTTs", "100 Mbps", 1000),
            "200 Mbps": generatePricing(999, "Unlimited", "550+ Channels", "29+ OTTs", "200 Mbps", 1000),
            "300 Mbps": generatePricing(1299, "Unlimited", "550+ Channels", "29+ OTTs", "300 Mbps", 1000),
            "500 Mbps": generatePricing(2499, "Unlimited", "650+ Channels", "29+ OTTs", "500 Mbps", 1000),
            "1000 Mbps": generatePricing(3999, "Unlimited", "650+ Channels", "29+ OTTs", "1000 Mbps", 1000),
            "2000 Mbps": generatePricing(9999, "Unlimited", "650+ Channels", "29+ OTTs", "2000 Mbps", 1000),
        }
    });
    function generatePricing(basePrice, data, tv, ott, speed, installationFee) {
        ...
        return {
            Monthly: createPlan(basePrice, data, tv, ott, "Monthly", getInstallationFee("Monthly")),
            Quarterly: createPlan(basePrice * 3, "Unlimited", tv, ott, "Quarterly",  getInstallationFee("Quarterly")),
            "Half Yearly": createPlan(halfDiscount, "Unlimited", tv, ott, "Half Yearly", getInstallationFee("Half Yearly")),
            Yearly: createPlan(fullDiscount, "Unlimited", tv, ott, "Yearly",  getInstallationFee("Yearly"))
        };
    }
    ...
    return (
        <PlansContext.Provider value={{ planOptions, setPlanOptions, activeTab, setActiveTab, checkCondition, setCheckCondition, activeNestedTab, setActiveNestedTab, activeChannel, setActiveChannel, activeOtts, setActiveOtts, price, setPrice, activeTag, setActiveTag }}>
            {children}
