  ...
  const dynamicImageContent = [
    {
      ...
      description: "Leverage cutting-edge broadband built for next-gen businesses.",
    },
    {
      img: "/assets/nationwide-reach.jpg",
      icon: ("/assets/pan-india.png"),
      title: "Nationwide Reach",
      description: "Offer services pan India with our expanding, reliable network.",
    },
    {
      img: "/assets/robust-infrastructure.jpg",
      icon: ("/assets/robust-architecture-new.png"),
      title: "Robust Infrastructure",
      description: "Built on the latest hardware to ensure speed and stability.",
    },
    {
      img: "/assets/ready-for-the-new-generation.jpg",
      icon: ("/assets/new-generation.png"),
      title: "Ready for the New Generation",
      description: "Enable experiences tailored for today’s connected families.",
    },
  ]
const SpeedContent = {
  ...
  slides: [
    {
      ...
      content: "Create long-term value by connecting families and shaping a digitally empowered future. Skylink partners become pillars of their local communities.",
      legal: "Partnership terms vary by region. Subject to approval.",
      image: "/assets/nextgen-wifi.jpg"
    },
    {
      title: "Empower the Nxt-Gen",
      content: "Help the next generation thrive with reliable internet, educational content, and smart home technology. Together, we bridge the digital gap.",
      legal: "Devices and services availability based on plan and region.",
      image: "/assets/device-upgrade-program.jpg"
    },
    {
      title: "Grow with Confidence",
      content: "Join a platform built for sustainable growth. With Skylink, you get modern tools, scalable infrastructure, and a trusted brand to power your business journey.",
      legal: "Tools and dashboards provided post onboarding.",
      image: "/assets/shield.jpg"
    },
    {
      title: "Stronger Together",
      content: "Skylink believes in collaboration. Our partner network is a family where knowledge-sharing, support, and innovation fuel shared success.",
...
const dynamicSlidesData = [
  ...
  return (
    <>
      <RectangleBanner backgroundImage="/assets/benefits-of-partnering.jpg"
      ...
      <SimpleColumnSection title="What’s Right for You?" columns={columnSaveContent2} />
      <div style={{ "marginTop": "-50px" }}>
        <ImageAndContent image="/assets/partner-with-purpose.jpg" content={contentData} />
      </div>
      <div style={{ "marginTop": "-100px", "marginBottom": "-70px" }}>
        <ImageAndContent row="row-reverse" image="/assets/a-superior choice.jpg" content={contentData2} />
      </div>
      <RightImageLeftContent row="row-reverse" title="Empowering Growth with Smart Technology" Content={dynamicImageContent} />
      <div style={{ "marginTop": "-35px" }}>
        <ImageAndContent row="row-reverse" image="/assets/build-on-innovation.jpg" content={contentData3} />
      </div>
      <SpeedBanner color="color-white" mainImage="/assets/grow-with-us.jpg" content={SpeedContent} />
      <DynamicCarousel title="Marketing and Support" slidesData={dynamicSlidesData} color="bg-gray-200" />
      <ContactFormNew />
