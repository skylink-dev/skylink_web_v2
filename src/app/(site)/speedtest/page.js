...
export const metadata = {
  ...
  description:
    "Test your current internet connection speed with Skylink's free online speed test. Measure your download and upload speeds accurately.",
  keywords: [
    "internet speed test",
    "bandwidth test",
    "network speed",
  ...
  openGraph: {
    title: "Internet Speed Test | Skylink",
    description:
      "Test your current internet connection speed with our free online tool.",
