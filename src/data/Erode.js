...
const ErodeData = {
    ...
    faq: {
        ...
        subtitle: "We've got the answers ready. Find quick information on all our plans and prices in Erode.",
        questions: [
            {
            ...
            },
            {
                ...
                answer: "We're working on it, coverage is expanding across Erode district. Drop us a message with your location and we'll tell you if we're there or when we will be."
            },
            {
            ...
            },
            {
                ...
                answer: "Yes. Home plans are optimized for streaming and browsing. Business plans offer static IP, higher uptime SLAs, and priority support. Best suited for offices and shops."
            },
            {
                question: "What happens if my internet goes down?",
                answer: "Call our local support team, we respond the same day for most issues in Erode. No waiting on hold with a faraway call center."
            },
            {
                question: "Can I get both internet and TV connection in one plan?",
                answer: "Yes. We offer bundled plans with fiber broadband and IPTV. Live TV plus OTT apps through a single device and remote."
            }
        ]
    }
};

export default ErodeData;