export const cardData = [
  {
    ...
    description: 'Get Broadband, OTT & Live TV with free installation and refundable Fire TV deposit.',
...
export const slidesData = [
  ...
  },
 {
  ...
  },
  {
    ...
    description: 'Addon - Hotstar, Zee5 — streaming redefined. Mega Max 29 OTT pack worth ₹299/- Free.',
...
export const dynamicImageContent = [
  {
    ...
    description: "We're working together to change the world by enhancing education, developing career opportunities, and bridging the digital divide. Learn how Skyplay is providing affordable & accessible internet.",
  },
  {
    img: "/assets/empowering-the-future.jpg",
    icon: ("/assets/empowering-the-future.png"),
    title: "Empowering the future",
    description: "From supporting low-income families with affordable internet to building the nation's infrastructure, learn how we're unlocking life's greater possibilities.",
  },
  {
    ...
    description: "Every child and family is different. We've teamed up with the American Academy of Pediatrics to develop resources to help your family stay safe on all screens.",
  },
]
...
export const IcontitleData = { title: "Connecting Your World", description: "Explore what makes our network unique.", links: [{ title: "Check 5G availability", url: "/" }, { title: "Check Fiber availability", url: "/" }] }
export const dynamicSlidesData = [
  ...
  },
  {
    ...
    description: "Manage content and screen time easily—from Hyderabad to Jaipur—with Skylink’s intuitive parental control tools.",
    normaltext: "",
