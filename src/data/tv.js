  export const bannerContent = {   subtitle: "Claim your free TV today!",
  ...
  offercta: "",
  secondcta: "Call (+91) 99441 99448", href:"/"}
  ...
  export const cartcontent = [{ image: "/assets/firestick-product-1.jpg", title: "Skylink Fire Tv", content: "Stream your favorite apps like Zee5, Amazon Prime, and Hotstar with the Amazon Fire TV Tv — easy setup and smooth 4K playback.", cta: "Shop", href:"/"}, { image: "/assets/skyplay-seupbox-and-remote.jpg", title: "4K Set-Top Box", content: "Enjoy crystal-clear visuals and smooth navigation with our advanced 4K-ready set-top box for IPTV and DTH services.", cta: "Shop", href:"/"}, { image: "/assets/remote-product.jpg", title: "Smart Remote Control", content: "Control all your Skylink devices with one intuitive, voice-enabled remote—simple, sleek, and powerful.", cta: "Shop", href:"/"}, { image: "/assets/high-spped-router.jpg", title: "High-Speed Dual Band Router", content: "Upgrade your internet experience with our dual-band router offering enhanced speed, range, and reliability for all your devices.", cta: "Shop", href:"/" }]
 export const tablecontent = [
  ...
  { title: "Free access to premium OTT apps (Zeetamil, Hotstar, Prime)", option1: "yes", option2: "yes", option3: "no" },
  ...
  export const cardData = [
    {
      ...
      subtitle: 'IPTV with Skylink — All You Need to Watch',
      title: 'Stream 1000+ Live Channels Starting at Just ₹399/month',
      description: 'Experience crystal-clear HD quality, zero buffering, and an easy-to-use interface.',
      legalText: 'No setup box, no dish required — just your Smart TV and an internet connection.',
      link: '/'
    },
    {
      image: '/assets/skyplay-tv-9.jpg',
      mobileimage:'/assets/save-big-with-iptv-3d-virtual.jpg',
      subtitle: 'Smart TV? You are Already Set!',
      title: 'Skylink IPTV runs right on your TV',
      description: 'No dish, no cables, and no bulky hardware. Just plug in your internet and start watching.',
      legalText: 'Access a full channel lineup directly through your TV — anytime, anywhere.',
      link: '/'
    }
  ];
  ...
  export const dynamicImageContent = [
    ...
    },
    {
      ...
      description: "Our IPTV services come with built-in parental controls and curated kids' zones — so your family can watch safely and responsibly across all screens.",
    },
  ]
  ...
  export const contentData = { subtitle: "", title: "A bundle for your home entertainment", description: "Save ₹65/mo. on everything you need for streaming. Plus, save an extra ₹30/mo. when you bundle with internet.", contentlists: ["IPTV HD Streaming", "On-Demand Movie Library", "Multi-Device Streaming Support"] }
  ...
  export const contentBaseBanner = { subtitle: "Choice is yours, guaranteed", title: "Get more with Skylink Unlimited Your Way", description: "Mix and match any of our best unlimited plans and get our best deals on any smartphone.* Starting at ₹399/mo. per line", policy: "Requires an active Skylink Unlimited Starter (SL) plan with eligible AutoPay setup and paperless billing. Taxes and fees are additional.Skylink Unlimited Premium (PL), Skylink Unlimited Extra (EL), and Skylink Unlimited Starter (SL).", subcta: "", cta: "Learn More", href:"/" };
  export const contentBaseBanner2 = { subtitle: "Skylink 5G. Fast. Reliable. Secure.", title: "The network you depend on to stay securely connected", description: "", policy: "Req's compatible plan & device. Coverage not available everywhere. Learn more at skylink.net.in", subcta: "", href:"/", cta: "Get to know Skylink 5G", href:"/"  };
