...
export const iconMenuData = [
  {
    ...
    icon: (
      <svg
        aria-label="Deals"
        data-testid="svgicon"
        className="height-md-all width-md-all mar-b-xxxs "
        aria-hidden="true"
        focusable="false"
        height="32"
        width="32"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          className="svg-base"
          d="M28 18h-4v-2h4a1 1 0 001-1V5a1 1 0 00-1-1H10a1 1 0 00-1 1v6H7V5a3 3 0 013-3h18a3 3 0 013 3v10a3 3 0 01-3 3zm0 2h-4v2h4zm-4 4v3a3 3 0 01-3 3H4a3 3 0 01-3-3v-3h2v-8a3 3 0 013-3h13a3 3 0 013 3v8zM5 24h15v-8a1 1 0 00-1-1H6a1 1 0 00-1 1zm17 2H3v1a1 1 0 001 1h17a1 1 0 001-1z"
        ></path>
      </svg>
    ),
    title: "IPTV",
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          className="svg-base"
          d="M5 24h2v5H5zm7 5h2V17h-2zm7 0h2V10h-2zm7-26v26h2V3z"
        ></path>
      </svg>
    ),
    title: "OTT",
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          className="svg-base"
          d="M15 26h2v2h-2zm-3.86-4.71l1.42 1.42a4.84 4.84 0 016.87 0l1.42-1.42a6.87 6.87 0 00-9.71 0zM1 11.29l1.41 1.42a19.21 19.21 0 0127.15 0L31 11.29a21.22 21.22 0 00-30 0zm5.05 5l1.41 1.42a12.08 12.08 0 0117.06 0l1.41-1.42a14.07 14.07 0 00-19.87 0z"
        ></path>
      </svg>
    ),
    title: "Partner",
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          className="svg-base"
          d="M20 20a3 3 0 01-3 3v2h-2v-2h-2v-2h4a1 1 0 000-2h-2a3 3 0 010-6v-2h2v2h2v2h-4a1 1 0 000 2h2a3 3 0 013 3zm5-16v24a3 3 0 01-3 3H10a3 3 0 01-3-3V4a3 3 0 013-3h12a3 3 0 013 3zm-2 0a1 1 0 00-1-1H10a1 1 0 00-1 1v24a1 1 0 001 1h12a1 1 0 001-1zm-4 1h-6v2h6z"
        ></path>
      </svg>
    ),
    title: "Deals",
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          className="svg-base"
          d="M22 31H10a3 3 0 01-3-3V4a3 3 0 013-3h12a3 3 0 013 3v24a3 3 0 01-3 3zM10 3a1 1 0 00-1 1v24a1 1 0 001 1h12a1 1 0 001-1V4a1 1 0 00-1-1zm9 2h-6v2h6z"
        ></path>
      </svg>
    ),
    title: "Moving",
...
export const dynamicSlidesData = [
  {
    ...
    description:
      "Access Zee5, Disney+, Prime, aha and more in one place. Skylink OTT brings together your favorite apps with a single subscription and smart interface.",
    normaltext: "",
    legalText: "",
    link: "/",
  },
  {
    ...
    description:
      "Enjoy uninterrupted, high-definition streaming across all your devices. Skylink ensures top performance with adaptive quality and zero buffering.",
    normaltext: "",
    legalText: "",
    link: "/",
  },
  {
    ...
    description:
      "From movies to sports to regional dramas, Skylink OTT packages content by interest—so you get exactly what you love, without the fluff.",
    normaltext: "",
    legalText: "",
    link: "/",
  },
  {
    ...
    description:
      "Prime Video, Zee5, JioCinema, and more, combined under the Skylink Playbox Mega\n" +
      "Max Pack.\n",
    normaltext: "",
    legalText: "",
    link: "/",
  },
  {
    ...
    description:
      "Discover your next binge-worthy show with AI-driven recommendations tailored to your preferences and watch history.",
    normaltext: "",
    legalText: "",
    link: "/",
  },
  {
    ...
    description:
      "From South stories to Hindi favorites, your entertainment moves with you",
    normaltext: "",
    legalText: "",
    link: "/",
  },
...
export const contentBaseBanner2 = {
  ...
  description:
    ...
    "space.",
  policy:
    "Visit our official plan page to explore features, plans, and partner platforms.",
  subcta: "",
  cta: "Check Out Plans",
  href: "/plans/",
};
