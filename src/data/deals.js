export const threeColumnData = [
  {
    image: "/assets/lightning-fast-internet-starting-atjust.jpg",
    subtitle: "Skylink Broadband",
    title: "Lightning-fast internet starting at just ₹399/mo",
    description:
      "Experience seamless streaming, gaming, and video calls with our high-speed fiber plans.",
    subdescription: "Speeds vary by location. Terms & conditions apply.",
    smallcta: "",
    cta: "Shop Now",
  },
  {
    image: "/assets/save-big-with-iptv-broadband-bundles.jpg",
    subtitle: "Skylink IPTV",
    title: "Over 500+ channels & exclusive OTT bundles",
    description:
      "Enjoy live TV, movies, sports & more — all in stunning HD with zero buffering.",
    subdescription: "Subscription required. Content availability varies.",
    smallcta: "",
    cta: "Subscribe Now",
  },
  {
    image: "/assets/over-500-channels-exclusive-OTT-bundles.jpg",
    subtitle: "Skylink Bundle",
    title: "Save big with IPTV + Broadband bundles",
    description:
      "Combine services and save up to ₹40/month. Perfect for homes & businesses.",
...
export const contentBaseData = {
  ...
  title: "Switch to Skylink today and get up to ₹399 per line",
  description:
    "Learn how to get a reward card to pay off your phone balance—up to 10 lines.",
  policy:
...
export const faqContent = [
  ...
  },
  {
    ...
    content:
      "If you are considering switching your internet service provider (ISP), chances are you are either moving to a new home or you might be staying put but looking to save money on your home internet bill or upgrade to a faster internet plan. Learn more about our best deals when you switch to Skylink Internet.",
  },
  {
    title:
      "If I’m an existing wire customer, what are Skylink’s best deals on home internet?",
    content:
      "Already have Skylink WirelessSM? Add Skylink Fiber or Skylink Internet Air service and save 20% a month on your internet bill.1 With Skylink Fiber, you can enjoy 99% reliability,2 unlimited internet data, and equal upload and download speeds. Or you can enjoy home internet, where available, on our 5G wire network with Internet Air.3 120% discount with eligible wire service applied to your internet bill within 2 bills. 2Based on network availability. 3Skylink Internet Air: In rare cases, if your usage is contributing to congestion on the network, Skylink will greatly reduce your speed for a min. of 30 min. 5G coverage not available everywhere.",
  },
];
export const contentNewsletter = {
  title: "Get the latest offers delivered to your inbox",
  description:
    "Sign up with your email address and be the first to hear about exclusive deals, limited-time promotions, and exciting new device launches.",
  terms:
    "By submitting your email address, you agree to receive future emails from Skylink and its family of companies We will email you offers and promotions about Skylink products and services.",
};
export const bannerContent = {
  subtitle: "Enjoy 15% and 7.5% discount offers now!",
  title:
    " Discover how much you can save when you subscribe to a new plan today.",
  firstcta: "",
  offercontent:
    "Limited Time Offer – Just ₹399/mo. off your bill for 36 months. Terms apply.",
  offercta: "",
...
export const Buttongroup = {
  ...
  buttons: [
    { buttontitle: "Compare Broadband", buttonurl: "/" },
    { buttontitle: "Compare IPTV", buttonurl: "/" },
    { buttontitle: "Compare OTT", buttonurl: "/" },
  ],
};
export const simpleContent = {
  ...
  subText:
    "DIRECTV is TV without compromise—with or without a satellite dish. Plus, get a 2-year price guarantee and your first Gemini device included!1",
...
export const dynamicImageContent = [
  {
    ...
    description:
      "Skylink Fiber delivers ultra-fast internet built for streaming, gaming, and smart homes with low latency.",
  },
  {
    ...
    description:
      "With Skylink mesh extenders, eliminate dead zones and enjoy consistent internet in every room.",
  },
  {
    ...
    description:
      "Skylink ActiveArmor protects your network from external threats and phishing attacks in real time.",
  },
  {
    ...
    description:
      "Use the Skylink Smart App to monitor usage, set parental controls, and manage devices connected to your broadband.",
  },
];
export const contentData = {
  subtitle: "",
  title: "Big Savings on Skylink Broadband Deals",
  description:
    "Get ultra-fast internet with unmatched reliability and coverage. Save up to ₹50/mo. when you bundle services.",
  contentlists: [
...
export const promoCardsData = [
  {
    ...
    description:
      "Save on Skylink Value Plus<sup>SM</sup> VL plans for the whole family.",
  ...
  },
  {
    ...
    description:
      "Earn a ₹200 statement credit after spending ₹1,000 in your first 3 months. Skylink Wireless customers can earn a ₹20 statement credit every billing cycle you spend ₹1,000+ on your card.",
