...
lyr_OpenTopoMap_0.setVisible(true);lyr_cbe_wards_map_20241coimbatore_ward_boundary_1.setVisible(true);
var layersList = [lyr_OpenTopoMap_0,lyr_cbe_wards_map_20241coimbatore_ward_boundary_1];
...
lyr_cbe_wards_map_20241coimbatore_ward_boundary_1.set('fieldLabels', {'id': 'no label', 'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'objectid': 'inline label - always visible', 'townname': 'no label', 'towncensuscode2011': 'no label', 'town_lgd_code': 'no label', 'ward_lgd_code': 'no label', 'ward_lgd_name': 'no label', 'sourcewardname': 'header label - always visible', 'sourcewardcode': 'no label', 'state': 'no label', 'zone': 'no label', 'st_area(shape)': 'no label', 'st_length(shape)': 'no label', });
